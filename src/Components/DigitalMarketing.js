  ...
  render() {
    return (
      <div>
        ...
        <br />
        <br />
        <CourseDetails courseTitle="Digital Marketing" />
        <div className="container course">
          <section>
            ...
            <details open>
              ...
              {
                this.state.courseData.filter((course) => { return (course.courseTitle === "Digital Marketing Course") }).map((summary) => {
            ...
            <details >
              ...
              <p>He is highly skilled at customer service, Microsoft word, excel, web development, digital marketing, with special skills in SEO, website audit, Google Analytics, bing ads amd many more..</p>
              <p className="summaryDetails">
